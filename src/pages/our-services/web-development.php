		...
		<div class="medium-10 medium-push-1 large-6 large-push-0 columns">
			<div class="workflowCard text-center" id="site-layout-planning" data-equalizer-watch>
				...
				<div class="workflowCard-description">
					<p class="color-white m-0">This includes the content strategy of what info will be presented <span class="display-inline-block">on the website.</span></p>
				</div>
			</div>
		</div>
	...
	<div class="row">
		<div class="medium-10 medium-push-1 large-8 large-push-2 columns end">
			<div class="workflowCard text-center" id="coding-development-stage">
				...
				<div class="workflowCard-description">
					<p class="color-white m-0">I then code the approved design into a functioning website, using the industry’s latest <span class="display-inline-block">methods and standards.</span></p>
				</div>
			</div>
		</div>
	</div>

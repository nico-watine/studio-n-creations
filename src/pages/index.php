		...
		<div class="medium-12 large-8 columns">
			<div class="row logos-row collapse">
				<div class="medium-4 columns text-center">
					...
					<img class="show-for-large" srcset="/img/index/graphic-branding/dmesa/dmesa-logo_2x.png 2x" src="/img/index/graphic-branding/dmesa/dmesa-logo.png" alt="d'Mesa Home logo" title="d'Mesa Home company logo - a Studio N Creation">
				</div>
				<div class="medium-push-4 medium-3 columns hide-for-large text-center">
					<img srcset="/img/index/graphic-branding/dmesa/dmesa-logo_2x.png 2x" src="/img/index/graphic-branding/dmesa/dmesa-logo.png" alt="d'Mesa Home logo" title="d'Mesa Home company logo - a Studio N Creation">
				</div>

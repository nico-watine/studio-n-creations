...
<section class="recent-projects">
	...
	<div class="row">
		<div class="medium-6 columns">
			<div class="project">
				<a data-open="starhill-farms-modal" title="StarHill Farms"><img src="/img/index/recent-projects/starhill-farms.png" alt="Starhill Farms website mockup"></a>
			</div>
		</div>
		<div class="medium-6 columns">
			<div class="project">
...
<div class="reveal row recent-projects-modal" id="starhill-farms-modal" data-reveal>
	<div class="medium-10 medium-push-1 columns end modal-container">
		...
		<div class="row collapse modal-prose">
			...
			<div class="large-5 columns large-text-center">
				<a class="button modal-site-link" href="http://starhillfarms.com/" target="_blank">www.StarHillFarms.com</a>
			</div>
		</div>
		<div class="row collapse modal-images">
			<div class="medium-6 columns">
